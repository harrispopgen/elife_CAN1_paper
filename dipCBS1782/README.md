## fig 5 contains three plots, fig 5A and 5B are from 1011 dataset while fig 5C includes incoporating variants called from a newly seqeunced CBS1782 strain with the existing 1011 dataset
