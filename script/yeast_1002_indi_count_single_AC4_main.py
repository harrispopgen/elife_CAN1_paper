...
if __name__ == '__main__':
    ...
    ## mutation_counts2 is dummy 
    mutaton_counts1, mutation_counts2, haplo_ids = count_mutations_single_chr( vcf_file, outgroup_tb ,1, [],[],4,0,4)
    ...
    for i in range(1,len(chromsomes)):
        ...
        mutaton_counts1, mutation_counts2, haplo_ids = count_mutations_single_chr(vcf_file, outgroup_tb, 0, mutaton_counts1, mutation_counts2,4,0,4)

    write_output1(mutaton_counts1, mutation_types_single, mutation_dict_single, haplo_ids, "../data/Scer_single_no_close_AC4_indi_mut_count_strain.txt")
